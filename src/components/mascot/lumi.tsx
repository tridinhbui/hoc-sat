...
export function Lumi({
  ...
  return (
    ...
    >
      ...
      <circle cx="60" cy="62" r="46" fill="#f5fcd1" />
      ...
      <ellipse cx="44" cy="58" rx="6.5" ry="8" fill="#4b1fcb" />
      <circle cx="42" cy="55" r="2.8" fill="#FFFFFF" />
      <circle cx="46.5" cy="61" r="1.4" fill="#FFFFFF" />

      <ellipse cx="76" cy="58" rx="6.5" ry="8" fill="#4b1fcb" />
      <circle cx="74" cy="55" r="2.8" fill="#FFFFFF" />
      <circle cx="78.5" cy="61" r="1.4" fill="#FFFFFF" />

      {/* Mũi đen nhỏ */}
      <ellipse cx="60" cy="66" rx="3.5" ry="2.5" fill="#4b1fcb" />

      {/* Má hồng hào */}
      <ellipse cx="36" cy="68" rx="4.5" ry="3" fill="#4c1979" opacity="0.35" />
      <ellipse cx="84" cy="68" rx="4.5" ry="3" fill="#4c1979" opacity="0.35" />
      ...
      {pose === "study" && (
        <g>
          ...
          <path d="M44 26L60 20L76 26L60 32L44 26Z" fill="#6f2dbd" />
          <path d="M50 28V36C50 39 60 41 60 41C60 41 70 39 70 36V28" fill="#4b1fcb" />
          <path d="M72 26V35" stroke="#4c1979" strokeWidth="1.5" strokeLinecap="round" />
          <circle cx="72" cy="36" r="1.5" fill="#4c1979" />
        </g>
      )}
      ...
      {pose === "gift" && (
        <g>
          ...
          <rect x="46" y="82" width="28" height="24" rx="4" fill="#6f2dbd" />
          <rect x="43" y="78" width="34" height="6" rx="2" fill="#6f2dbd" />
          <line x1="60" y1="78" x2="60" y2="106" stroke="#c7f000" strokeWidth="4" />
          <path d="M55 76C53 72 56 69 60 74C64 69 67 72 65 76Z" fill="#4c1979" />
        </g>
      )}
...
export function MockTestIllustration({ size = 180, className }: { size?: number; className?: string }) {
  return (
    ...
    >
      ...
      <circle cx="80" cy="80" r="70" fill="#eaf9ef" />
      ...
      <g transform="rotate(-4 54 48)">
        {/* Câu 1 */}
        <rect x="54" y="48" width="30" height="4" rx="2" fill="#c3e4cf" />
        <circle cx="92" cy="50" r="4" fill="#e3f2e9" />
        <circle cx="103" cy="50" r="4" fill="#4c1979" />

        {/* Câu 2 */}
        <rect x="54" y="60" width="36" height="4" rx="2" fill="#c3e4cf" />
        <circle cx="92" cy="62" r="4" fill="#4c1979" />
        <circle cx="103" cy="62" r="4" fill="#e3f2e9" />

        {/* Câu 3 */}
        <rect x="54" y="72" width="28" height="4" rx="2" fill="#c3e4cf" />
        <circle cx="92" cy="74" r="4" fill="#e3f2e9" />
        <circle cx="103" cy="74" r="4" fill="#4c1979" />

        {/* Câu 4 */}
        <rect x="54" y="84" width="40" height="4" rx="2" fill="#c3e4cf" />
        <circle cx="92" cy="86" r="4" fill="#4c1979" />
        <circle cx="103" cy="86" r="4" fill="#e3f2e9" />
      </g>

      {/* Bút chì 3D màu vàng cam hướng vào bài thi */}
      <g transform="rotate(35 95 90)">
        <rect x="90" y="60" width="12" height="45" rx="3" fill="#4c1979" />
        <rect x="90" y="60" width="4" height="45" rx="1" fill="#c7f000" />
        <path d="M90 105L96 117L102 105Z" fill="#c7f000" />
        <path d="M94 113L96 117L98 113Z" fill="#4b1fcb" />
        <rect x="90" y="54" width="12" height="7" rx="2" fill="#4c1979" />
        <rect x="90" y="60" width="12" height="3" fill="#e3f2e9" />
      </g>
      ...
      <g transform="translate(108, 92)">
        ...
        <path d="M16 8V16L21 16" stroke="#6f2dbd" strokeWidth="2.5" strokeLinecap="round" />
        <rect x="14" y="0" width="4" height="4" rx="1" fill="#6f2dbd" />
      </g>

      {/* Những ngôi sao lấp lánh */}
      <path d="M30 42L32 46L36 48L32 50L30 54L28 50L24 48L28 46Z" fill="#c7f000" />
      <path d="M136 40L137.5 43L140 44L137.5 45L136 48L134.5 45L132 44L134.5 43Z" fill="#c7f000" />
    </svg>
  );
}
...
export function LeagueShield({ tier = "bronze", size = 64 }: { tier?: "bronze" | "silver" | "gold"; size?: number }) {
  const colors = {
    bronze: { primary: "#4c1979", light: "#c7f000", base: "#4c1979", bg: "#c7f000" },
    silver: { primary: "#6f2dbd", light: "#eef4f0", base: "#4b1fcb", bg: "#f6faf7" },
    gold: { primary: "#4c1979", light: "#c7f000", base: "#4c1979", bg: "#c7f000" },
  }[tier];
